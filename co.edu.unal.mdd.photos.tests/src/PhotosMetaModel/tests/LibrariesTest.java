...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Libraries</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class LibrariesTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(LibrariesTest.class);
	}

	/**
	 * Constructs a new Libraries test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void setUp() throws Exception {
		setFixture(PhotosMetaModelFactory.eINSTANCE.createLibraries());
	}
