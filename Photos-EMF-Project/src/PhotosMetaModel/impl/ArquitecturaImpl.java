 ...
 * </p>
 * <ul>
 *   <li>{@link PhotosMetaModel.impl.ArquitecturaImpl#getNtier <em>Ntier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArquitecturaImpl extends MinimalEObjectImpl.Container implements Arquitectura {
	...
	protected EClass eStaticClass() {
		return SystemMetamodelPackage.Literals.ARQUITECTURA;
	}
	...
	public EList<Ntier> getNtier() {
		if (ntier == null) {
			ntier = new EObjectContainmentEList<Ntier>(Ntier.class, this, SystemMetamodelPackage.ARQUITECTURA__NTIER);
		}
		return ntier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SystemMetamodelPackage.ARQUITECTURA__NTIER:
