...
public class SystemMetamodelFactoryImpl extends EFactoryImpl implements SystemMetamodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SystemMetamodelPackage.EDITAR_PERFIL: return createEditarPerfil();
			case SystemMetamodelPackage.NTIER: return createNtier();
			case SystemMetamodelPackage.CAPAS: return createCapas();
			case SystemMetamodelPackage.RELACIONES: return createRelaciones();
			case SystemMetamodelPackage.CONEXIONES: return createConexiones();
			default:
	 ...
	 */
	@Override
	public Capas createCapas() {
		CapasImpl capas = new CapasImpl();
		return capas;
	}
	 ...
	 */
	@Override
	public Conexiones createConexiones() {
		ConexionesImpl conexiones = new ConexionesImpl();
		return conexiones;
	}
