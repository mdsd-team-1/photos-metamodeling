...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>SystemMetamodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemMetamodelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SystemMetamodelPackage.eNS_URI, 
			 SystemMetamodelPackage.eINSTANCE);
