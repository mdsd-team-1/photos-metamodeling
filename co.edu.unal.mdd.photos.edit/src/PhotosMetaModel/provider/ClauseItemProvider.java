...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Clause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClauseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clause_keyword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clause_keyword_feature", "_UI_Clause_type"),
				 PhotosMetaModelPackage.Literals.CLAUSE__KEYWORD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Clause)object).getKeyword();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Clause.class)) {
			case PhotosMetaModelPackage.CLAUSE__KEYWORD:
