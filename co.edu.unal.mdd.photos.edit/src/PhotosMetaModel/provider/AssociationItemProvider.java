...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.ASSOCIATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.ASSOCIATION__TARGET,
				 true,
				 false,
				 true,
				 null,
