...
/**
 * This is the item provider adapter for a {@link SystemMetamodel.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.SCHEMA__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemMetamodelPackage.Literals.SCHEMA__TABLES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Schema.class)) {
			case SystemMetamodelPackage.SCHEMA__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SystemMetamodelPackage.SCHEMA__TABLES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.SCHEMA__TABLES,
				 SystemMetamodelFactory.eINSTANCE.createTable()));
	}
