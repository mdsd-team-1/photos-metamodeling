...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Services} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServicesItemProvider extends ActionsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Services_request_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Services_request_feature", "_UI_Services_type"),
				 PhotosMetaModelPackage.Literals.SERVICES__REQUEST,
				 true,
				 false,
				 true,
				 null,
