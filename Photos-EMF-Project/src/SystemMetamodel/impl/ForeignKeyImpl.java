...
public class ForeignKeyImpl extends MinimalEObjectImpl.Container implements ForeignKey {
	...
	protected EClass eStaticClass() {
		return SystemMetamodelPackage.Literals.FOREIGN_KEY;
	}
		...
		if (refersTo != null && refersTo.eIsProxy()) {
			...
			if (refersTo != oldRefersTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SystemMetamodelPackage.FOREIGN_KEY__REFERS_TO, oldRefersTo, refersTo));
			}
		}
		return refersTo;
	}
	...
	public void setRefersTo(Table newRefersTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemMetamodelPackage.FOREIGN_KEY__REFERS_TO, oldRefersTo, refersTo));
	}
	...
	public Column getColumn() {
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SystemMetamodelPackage.FOREIGN_KEY__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(Column newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemMetamodelPackage.FOREIGN_KEY__COLUMN, oldColumn, column));
	}
