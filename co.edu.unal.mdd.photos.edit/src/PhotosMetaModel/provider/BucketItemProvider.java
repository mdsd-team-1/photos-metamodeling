...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Bucket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BucketItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bucket_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bucket_name_feature", "_UI_Bucket_type"),
				 PhotosMetaModelPackage.Literals.BUCKET__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Bucket)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Bucket_type") :
			getString("_UI_Bucket_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PhotosMetaModelPackage.Literals.BUCKET__FILE_A,
