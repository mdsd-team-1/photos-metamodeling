...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Information} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationItemProvider extends ModulesItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Information_fileType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Information_fileType_feature", "_UI_Information_type"),
				 PhotosMetaModelPackage.Literals.INFORMATION__FILE_TYPE,
				 true,
				 false,
				 false,
