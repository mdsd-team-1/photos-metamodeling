...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Predicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Predicate_specification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Predicate_specification_feature", "_UI_Predicate_type"),
				 PhotosMetaModelPackage.Literals.PREDICATE__SPECIFICATION,
				 true,
				 false,
				 true,
				 null,
