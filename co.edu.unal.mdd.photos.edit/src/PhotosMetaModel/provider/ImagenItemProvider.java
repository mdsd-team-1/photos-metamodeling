...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Imagen} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Imagen_categoria_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Imagen_categoria_feature", "_UI_Imagen_type"),
				 PhotosMetaModelPackage.Literals.IMAGEN__CATEGORIA,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Imagen_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Imagen_id_feature", "_UI_Imagen_type"),
				 PhotosMetaModelPackage.Literals.IMAGEN__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Imagen_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Imagen_name_feature", "_UI_Imagen_type"),
				 PhotosMetaModelPackage.Literals.IMAGEN__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
