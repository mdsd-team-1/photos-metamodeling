...
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	protected EClass eStaticClass() {
		return SystemMetamodelPackage.Literals.ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemMetamodelPackage.ENTITY__NAME, oldName, name));
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SystemMetamodelPackage.ENTITY__ACCESS, oldAccess, access));
	}
