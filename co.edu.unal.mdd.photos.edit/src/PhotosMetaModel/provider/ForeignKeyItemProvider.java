...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.FOREIGN_KEY__COLUMN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.FOREIGN_KEY__REFERENCE,
				 true,
				 false,
				 true,
				 null,
