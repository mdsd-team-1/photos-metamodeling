 ...
 * </p>
 * <ul>
 *   <li>{@link PhotosMetaModel.impl.RelationImpl#getSourceLayer <em>Source Layer</em>}</li>
 *   <li>{@link PhotosMetaModel.impl.RelationImpl#getTargetLayer <em>Target Layer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	...
	protected EClass eStaticClass() {
		return PhotosMetaModelPackage.Literals.RELATION;
	}
		...
		if (sourceLayer != null && sourceLayer.eIsProxy()) {
			...
			if (sourceLayer != oldSourceLayer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PhotosMetaModelPackage.RELATION__SOURCE_LAYER, oldSourceLayer, sourceLayer));
			}
		}
		return sourceLayer;
	}
	...
	public void setSourceLayer(Layer newSourceLayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhotosMetaModelPackage.RELATION__SOURCE_LAYER, oldSourceLayer, sourceLayer));
	}
	...
	public Layer getTargetLayer() {
		if (targetLayer != null && targetLayer.eIsProxy()) {
			...
			if (targetLayer != oldTargetLayer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PhotosMetaModelPackage.RELATION__TARGET_LAYER, oldTargetLayer, targetLayer));
			}
		}
		return targetLayer;
	}
	...
	public void setTargetLayer(Layer newTargetLayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhotosMetaModelPackage.RELATION__TARGET_LAYER, oldTargetLayer, targetLayer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PhotosMetaModelPackage.RELATION__SOURCE_LAYER:
				if (resolve) return getSourceLayer();
				return basicGetSourceLayer();
			case PhotosMetaModelPackage.RELATION__TARGET_LAYER:
