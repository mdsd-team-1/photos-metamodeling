...
/**
 * This is the item provider adapter for a {@link SystemMetamodel.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.FOLDER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemMetamodelPackage.Literals.FOLDER__FILES);
			childrenFeatures.add(SystemMetamodelPackage.Literals.FOLDER__CONTAINS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Folder.class)) {
			case SystemMetamodelPackage.FOLDER__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SystemMetamodelPackage.FOLDER__FILES:
			case SystemMetamodelPackage.FOLDER__CONTAINS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.FOLDER__CONTAINS,
