...
/**
 * This is the item provider adapter for a {@link SystemMetamodel.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.TABLE__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemMetamodelPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(SystemMetamodelPackage.Literals.TABLE__FOREIGN_KEYS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.TABLE__COLUMNS,
				 SystemMetamodelFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.TABLE__FOREIGN_KEYS,
				 SystemMetamodelFactory.eINSTANCE.createForeignKey()));
	}
