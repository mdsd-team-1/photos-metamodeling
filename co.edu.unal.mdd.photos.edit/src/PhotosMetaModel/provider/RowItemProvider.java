...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Row} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.ROW__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PhotosMetaModelPackage.Literals.ROW__POLICY);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(PhotosMetaModelPackage.Literals.ROW__POLICY,
				 PhotosMetaModelFactory.eINSTANCE.createPolicy()));
	}
