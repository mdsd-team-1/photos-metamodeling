...
/**
 * This is the item provider adapter for a {@link SystemMetamodel.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.FILE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case SystemMetamodelPackage.FILE__NAME:
			case SystemMetamodelPackage.FILE__EXTENSION:
