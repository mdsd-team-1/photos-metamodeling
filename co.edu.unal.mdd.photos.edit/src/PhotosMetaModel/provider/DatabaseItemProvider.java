...
/**
 * This is the item provider adapter for a {@link PhotosMetaModel.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhotosMetaModelPackage.Literals.DATABASE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PhotosMetaModelPackage.Literals.DATABASE__SCHEME);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Database.class)) {
			case PhotosMetaModelPackage.DATABASE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PhotosMetaModelPackage.DATABASE__SCHEME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PhotosMetaModelPackage.Literals.DATABASE__SCHEME,
				 PhotosMetaModelFactory.eINSTANCE.createScheme()));
	}
