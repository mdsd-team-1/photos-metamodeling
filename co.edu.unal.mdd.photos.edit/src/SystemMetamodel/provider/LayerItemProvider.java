...
/**
 * This is the item provider adapter for a {@link SystemMetamodel.Layer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemMetamodelPackage.Literals.LAYER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemMetamodelPackage.Literals.LAYER__LAYER_SEGMENTS);
			childrenFeatures.add(SystemMetamodelPackage.Literals.LAYER__CONNECTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.LAYER__LAYER_SEGMENTS,
				 SystemMetamodelFactory.eINSTANCE.createLayerSegment()));

		newChildDescriptors.add
			(createChildParameter
				(SystemMetamodelPackage.Literals.LAYER__CONNECTIONS,
				 SystemMetamodelFactory.eINSTANCE.createConnection()));
	}
